...
Compatible avec Stlite (GitHub Pages)
"""

import streamlit as st
from fractions import Fraction

# Import des modules (sans sys.path pour Stlite)
try:
    from heir_detector import HeirDetector, Heir
    from heritage_calculator import HeritageCalculator
except ImportError:
    st.error("⚠️ Erreur d'importation des modules. Vérifiez que heir_detector.py et heritage_calculator.py sont présents.")
    st.stop()
